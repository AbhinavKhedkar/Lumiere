  ...
  return (
    <footer className="flex flex-col p-12 md:p-16 mt-20">
      <div className="flex flex-col md:flex-row">
        <div className="flex flex-col mb-8">
          <div className="flex flex-wrap mb-16 border-b-4 border-solid border-[#6AAF6F]">
            <h3 className="footer-text-1 text-[#054000] font-[Oswald] text-3xl md:text-5xl text-wrap font-light leading-10 md:leading-12 tracking-wide text-left">
              Designed And Developed By Reboot Consultancy And Services
            </h3>
          </div>
          <div>
            <h4 className="text-[#054000] font-[Oswald] text-xl md:text-2xl font-light md:font-normal leading-8 tracking-wide text-left">Contact Details:-</h4>
            <ul className="mt-4">
              <li className="text-[#064600] font-[Oswald] text-base font-light leading-6 tracking-wide text-left hover:text-[#459E00]">
      ...
      <div className="flex flex-row justify-between items-center mt-12">
        <p className="text-[#064600] font-[Oswald] text-base font-light leading-6 tracking-wide text-left text-wrap">
